...
export default function ClientsLogo() {
  return (
    <>
      ...
      >
        <ul x-ref="logos" className="py-14 flex items-center justify-center md:justify-start [&_li]:mx-8 [&_img]:max-w-none animate-infinite-scroll">
          <li>
          ...
          <li>
            <Image src="/Polimetal.png" width={200} height={100} alt="Polimetal" />
          </li>
          <li>
        ...
        <ul className="py-14 flex items-center justify-center md:justify-start [&_li]:mx-8 [&_img]:max-w-none animate-infinite-scroll" aria-hidden="true">
          <li>
            <Image src="/3Afest.png" width={200} height={100} alt="3Afest" />
          </li>
          <li>
