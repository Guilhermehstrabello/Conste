...
export async function GET() {
  try {
    ...
    const hasAnon = typeof process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_DEFAULT_KEY === 'string' && process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_DEFAULT_KEY.length > 0;
