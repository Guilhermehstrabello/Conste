    ...
    <>
      ...
      <section className="py-12 px-10 flex flex-col gap-12" id="cases">
        ...
        <div className="flex md:flex-row flex-col items-center justify-center gap-x-10 gap-y-10">
          <div className="flex flex-col justify-center items-center max-w-[1200px] p-4 gap-6 w-[370px] h-full border border-[#310276] hover:bg-[#30027659] duration-500 ease-in-out rounded-[10px]">
            {/* Imagem */}
            <Image src="/Polimetal.png" width={200} height={88} alt="JE Polimetal Logo" />

            {/* Case Stats Container */}
            <div className="flex flex-col justify-center items-center gap-4 w-[260px] h-[380px]">
          ...
          <div className="flex flex-col justify-center items-center p-4 gap-6 w-[370px] h-full border border-[#310276] hover:bg-[#30027659] duration-500 ease-in-out rounded-[10px]">
